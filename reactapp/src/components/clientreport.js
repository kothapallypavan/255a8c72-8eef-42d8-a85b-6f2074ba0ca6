...
const Clientreport = () => {  
    ...
    const[tempreport,setReport]=useState("");
    ...
    <div>
      ...
      <Card style={{ width: '25rem',height:'38rem',border:'2px solid grey',borderRadius: '4%',textAlign:'center',marginRight:'20px',marginTop:'20px'}}>
          <Card.Body style={{overflow:"hidden"}}>
            <Card.Title style={{marginLeft:"20px"}}>Case Report<CloseButton aria-label="Hide" onClick={closebutton} style={{float:"right"}}/></Card.Title>
          <div>
          ...
          <Card.Text style={{marginTop:"100px",marginBottom:"0px"}}>{tempslot}</Card.Text>
            ...
            <Form.Control as="textarea" id="formtext" rows={12} style={{resize: "none",margin:"20px 0px",backgroundColor:"skyblue"}} value={tempreport} disabled/>
